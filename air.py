...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Mohammed Huzaifa M H"}')
    mail = (f'{"Mail :"}  {"mohammedhuzaifa284@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Users\\Admin\\OneDrive\\Desktop\\Capstone3\\airbnb.jpg"), width=300)
    with col2:
        st.header('Airbnb Analysis')
        st.subheader(
